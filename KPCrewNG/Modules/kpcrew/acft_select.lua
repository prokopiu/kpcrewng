...
function ng_acft_select()
	...
	if ng_file_exists(SCRIPT_DIRECTORY.."../Modules/kpcrew/addons/"..ng_acf_icao.."_sop.json") and 
	   ng_file_exists(SCRIPT_DIRECTORY.."../Modules/kpcrew/addons/"..ng_acf_icao.."_systems.json") and
	   ng_file_exists(SCRIPT_DIRECTORY.."../Modules/kpcrew/addons/"..ng_acf_icao.."_preferences.lua") then
		return icao
	else
