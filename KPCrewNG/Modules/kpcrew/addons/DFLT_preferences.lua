...
local aircraftPrefSet = preferenceSet:new("DFLT","AIRCRAFT DFLT PREFERENCES",SCRIPT_DIRECTORY .. "../Modules/kpcrew_prefs/DFLT.preferences")

-- General settings not associated with a preference group
local general = preferenceGroup:new("general","GENERAL PREFERENCES")
general:add(preference:new("isairbus",false,ng_type_flag,"Airbus?|Yes|No"))
general:add(preference:new("isboeing",false,ng_type_flag,"Boeing?|Yes|No"))
general:add(preference:new("isga",false,ng_type_flag,"GA?|Yes|No"))
general:add(preference:new("isturboprop",false,ng_type_flag,"Turboprop?|Yes|No"))
general:add(preference:new("iscargo",false,ng_type_flag,"Cargo?|Yes|No"))
general:add(preference:new("hasautobrk",false,ng_type_flag,"Autobrake?|Yes|No"))
general:add(preference:new("abrkemode",1,ng_type_list,"A/BRK|OFF|1|2|3|MAX"))
general:add(preference:new("hasseatbelt",true,ng_type_flag,"Seatbelts?|Yes|No"))
general:add(preference:new("hasnosmoking",true,ng_type_flag,"No Smoking?|Yes|No"))
general:add(preference:new("numadirs",3,ng_type_int,"AD-IRS?|0"))
general:add(preference:new("hasstairs",false,ng_type_flag,"Stairs?|Yes|No"))
general:add(preference:new("hasgear",true,ng_type_flag,"Retract Gear?|Yes|No"))
general:add(preference:new("hasgroundobj",false,ng_type_flag,"Ground Obj?|Yes|No"))
general:add(preference:new("haswipers",true,ng_type_flag,"Wipers?|Yes|No"))
general:add(preference:new("haswxradar",false,ng_type_flag,"WX Radar?|Yes|No"))
general:add(preference:new("hastoc",false,ng_type_flag,"TOC?|Yes|No"))
general:add(preference:new("haschrono",false,ng_type_flag,"Chrono?|Yes|No"))
general:add(preference:new("hasclock",false,ng_type_flag,"Clock?|Yes|No"))
general:add(preference:new("hasxpdr",true,ng_type_flag,"XPDR?|Yes|No"))
general:add(preference:new("hasdoors",true,ng_type_flag,"Doors?|Yes|No"))
general:add(preference:new("hascargodoors",true,ng_type_flag,"Doors Cargo?|Yes|No"))
general:add(preference:new("hascockpitdoor",true,ng_type_flag,"Cockpit Door?|Yes|No"))
general:add(preference:new("haswindows",false,ng_type_flag,"Windows?|Yes|No"))

ng_LandingAutoBrake = "OFF|1|2|3|MAX"
ng_LandingAutoBrInd = "1|2|3|4|5"
ng_AutoBrakeOff		= 1
ng_AutoBrakeRTO		= 0
...
controls:add(preference:new("hasflaps",true,ng_type_flag,"Flaps?|Yes|No"))
controls:add(preference:new("flapsdetents",8,ng_type_int,"Flaps Detents|0"))
controls:add(preference:new("numtoflaps",6,ng_type_int,"# T/O Flaps|0"))
controls:add(preference:new("toflaps",1,ng_type_list,"T/O Flaps|UP|1|2|3|4|5|6|7"))
controls:add(preference:new("toflapsind","0|1|2|3|4|5|6|7",ng_type_text,"T/O Flaps Index|"))
controls:add(preference:new("numldflaps",3,ng_type_int,"# LDG Flaps|0"))
controls:add(preference:new("ldflaps",1,ng_type_list,"LDG Flaps|6|30|FULL"))
controls:add(preference:new("ldflapsind","0|7|8|9|9|9|9|9",ng_type_text,"LDG Flaps Index|"))
controls:add(preference:new("gearextind",2,ng_type_int,"Gear extend ldg|0"))
controls:add(preference:new("announceflaps",false,ng_type_flag,"Announce Flaps?|Yes|No"))
controls:add(preference:new("hasspdbreak",true,ng_type_flag,"Speedbreak?|Yes|No"))
controls:add(preference:new("spdbreakarms",true,ng_type_flag,"Speedbreak Arms?|Yes|No"))
controls:add(preference:new("spdbreakapos",0.0889,ng_type_float,"SpdBreak Arm Pos|0|%6.2f"))
...
-- Anything associated to electric power
local electric = preferenceGroup:new("electric","ELECTRIC SYSTEMS")
electric:add(preference:new("numbatteries",1,ng_type_int,"# Batteries|0"))
...
electric:add(preference:new("hasgpu",true,ng_type_flag,"GPU?|Yes|No"))
electric:add(preference:new("numgpugens",1,ng_type_int,"# GPU Generators|0"))
electric:add(preference:new("hasapu",true,ng_type_flag,"APU?|Yes|No"))
electric:add(preference:new("numapugens",1,ng_type_int,"# APU Generators|0"))
electric:add(preference:new("numstbypower",0,ng_type_int,"# Standby Pwr Switch|0"))
...
-- All hydraulic power related settings
local hydraulic = preferenceGroup:new("hydraulic","HYDRAULIC SYSTEMS")
hydraulic:add(preference:new("numhydelecpmps",2,ng_type_int,"# Electric Hyd Pumps|0"))
...
air:add(preference:new("numrecircfans",0,ng_type_int,"# Recirc Fans|0"))
air:add(preference:new("hasequipcool",false,ng_type_flag,"Equip Cool?|Yes|No"))
air:add(preference:new("hastrimair",false,ng_type_flag,"Trim Air?|Yes|No"))
air:add(preference:new("numtempcontrol",0,ng_type_int,"# Temp Control|0"))
...
aice:add(preference:new("numengaice",2,ng_type_int,"# Engine A-Ice|0"))
aice:add(preference:new("numwingaice",2,ng_type_int,"# Wing A-Ice|0"))
aice:add(preference:new("numwinheat",4,ng_type_int,"# Window Heat|0"))
aice:add(preference:new("numpitotheat",2,ng_type_int,"# Pitot Heat|0"))
aice:add(preference:new("takeoffaice",1,ng_type_list,"Takeoff A-Ice|OFF|ENGINE|ENGINE & WING"))
aice:add(preference:new("landingaice",1,ng_type_list,"Landing A-Ice|OFF|ENGINE|ENGINE & WING"))
...
lights:add(preference:new("numbeaconlts",1,ng_type_int,"# Beacons|0"))
...
lights:add(preference:new("numdomelts",1,ng_type_int,"# Dome Lights|0"))
...
lights:add(preference:new("numemerlts",1,ng_type_int,"# Emergency Lights|0"))
...
-- Autopilot
local autopilot = preferenceGroup:new("autopilot","AUTO PILOT")
...
ng_flaps_name 	= {[1] = "UP",[2] =   "1", [3] =  "2", [4] =   "3", [5] = "4", [6] =  "5",  [7] =  "6", [8] =   "7", [9] = "FULL"}
ng_flaps_idx 	= {"UP",      "1",         "2",        "3",         "4",       "5",         "6",        "7",         "FULL"}
