...
ng_getAcfPrefs():setName("B737")
ng_getAcfPrefs():setTitle("ZIBO B738 / LEVEL UP")
ng_getAcfPrefs():setFilePath(SCRIPT_DIRECTORY .. "../Modules/kpcrew_prefs/B737.preferences")

-- -------- General settings not associated with a preference group --------
ng_getAcfPrefs():set("general:hasautobrk",true)
ng_getAcfPrefs():set("general:haswipers",true)
ng_getAcfPrefs():set("general:hasfiretests",true)
-- autobreak related setting
ng_getAcfPrefs():set("general:abrkmodelblt","|RTO|OFF|1|2|3|MAX")
ng_getAcfPrefs():set("general:abrkmodevals","|0|1|2|3|4|5")
ng_getAcfPrefs():set("general:abrkoffval",1)
ng_getAcfPrefs():set("general:abrktroval",0)

-- ----------------------- Electric related settings ------------------------
ng_getAcfPrefs():set("electric:hasstbypower",true)

-- ----------------------- Hydraulic related settings -----------------------
ng_getAcfPrefs():set("hydraulic:hashydelecpmps",true)

-- local general = ng_getAcfPrefs():findGroup("general")
...
-- ----------------------- Electric related settings ------------------------
ng_getAcfPrefs():set("electric:hasstbypower",true)
ng_getAcfPrefs():set("electric:hasgpu",true)
ng_getAcfPrefs():set("electric:hasapu",true)
ng_getAcfPrefs():set("electric:apun1run",98)
...
ng_getAcfPrefs():set("air:hastempcontrol",true)
ng_getAcfPrefs():set("air:hastrimair",true)
ng_getAcfPrefs():set("air:hasrecircfans",true)
...
ng_getAcfPrefs():set("lights:hasbeacon",true)
ng_getAcfPrefs():set("lights:numbeaconlts",1)
ng_getAcfPrefs():set("lights:hasemerlts",true)
...
ng_getAcfPrefs():set("autopilot:hasirs",true)
ng_getAcfPrefs():set("autopilot:irsoff",0)
ng_getAcfPrefs():set("autopilot:irsalign",1)
ng_getAcfPrefs():set("autopilot:irsnav",2)
ng_getAcfPrefs():set("autopilot:irsatt",3)
