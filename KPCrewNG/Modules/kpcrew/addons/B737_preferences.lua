...
local aircraftPrefSet = preferenceSet:new("B737","ZIBO B738 / LEVEL UP",SCRIPT_DIRECTORY .. "../Modules/kpcrew_prefs/DFLT.preferences")
...
general:add(preference:new("isboeing",true,ng_type_flag,"Boeing?|Yes|No"))
...
general:add(preference:new("hasautobrk",true,ng_type_flag,"Autobrake?|Yes|No"))
general:add(preference:new("abrkemode",1,ng_type_list,"A/BRK|RTO|OFF|1|2|3|MAX"))
...
general:add(preference:new("hasstairs",true,ng_type_flag,"Stairs?|Yes|No"))
...
general:add(preference:new("haswxradar",true,ng_type_flag,"WX Radar?|Yes|No"))
general:add(preference:new("hastoc",false,ng_type_flag,"TOC?|Yes|No"))
general:add(preference:new("haschrono",true,ng_type_flag,"Chrono?|Yes|No"))
general:add(preference:new("hasclock",true,ng_type_flag,"Clock?|Yes|No"))
...
ng_LandingAutoBrake = "RTO|OFF|1|2|3|MAX"
...
controls:add(preference:new("toflaps",1,ng_type_list,"T/O Flaps|UP|1|5|10|15"))
controls:add(preference:new("toflapsind","1|2|4|5|6",ng_type_text,"T/O Flaps Index|"))
controls:add(preference:new("numldflaps",3,ng_type_int,"# LDG Flaps|0"))
controls:add(preference:new("ldflaps",1,ng_type_list,"LDG Flaps|25|30|40"))
controls:add(preference:new("ldflapsind","7|8|9",ng_type_text,"LDG Flaps Index|"))
