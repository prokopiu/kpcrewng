...
function str_to_cstar(textValue)
	local c_str = ffi.new("char[?]", #textValue + 1)
	ffi.copy(c_str, textValue)
	return c_str
end
...
ImFont["SetFallbackChar"] = ImFont["SetFallbackChar"]  or function(i1, i2)
    local out = C.ImFont_SetFallbackChar(i1, i2)
    return out
end
...
M.GetWindowContentRegionWidth = M.GetWindowContentRegionWidth  or function()
    local out = C.igGetWindowContentRegionWidth()
    return out
end
...
M.InputTextMultiline = M.InputTextMultiline  or function(i1, i2, i3, i4, i5, i6, i7)
    ...
    if i5 == nil then i5 = 0 end
--	if i2 ~= nil then i2 = str_to_cstar(i2) end
...
M.CalcListClipping = M.CalcListClipping  or function(i1, i2)
    local o1 = ffi.new("int[1]")
    local o2 = ffi.new("int[1]")
    local out = C.igCalcListClipping(i1, i2, o1, o2)
    return o1[0], o2[0], out
end
...
M.OpenPopup = M.OpenPopup  or function(i1, i2)
    if i2 == nil then i2 = 0 end
    local out = C.igOpenPopup(i1, i2)
    return out
end
